    ...
    <section className="py-24 bg-blue-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-4xl font-bold mb-6">Why Choose IT Carolina?</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-8">
            <motion.div 
              className="bg-blue-800/50 rounded-xl p-8 hover:bg-blue-800/70 transition-colors duration-300 border border-blue-700/30"
            ...
            >
              <div className="flex items-start">
                <div className="bg-blue-700 rounded-xl p-4 mr-5">
        ...
        >
          <button 
            ...
            className="inline-flex items-center px-8 py-4 bg-white text-blue-900 rounded-md hover:bg-blue-100 transition-all duration-300 text-lg font-medium hover:scale-[1.02]"
          >
